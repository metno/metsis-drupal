...
drupal_set_message("<b>XYZ local VM clone</b>", 'warning');
drupal_set_message("<b>SIOS local VM clone</b>", 'warning');
/**
 * @file
...
$metsis_conf['solr_core_parent'] = 'sios-l1';
$metsis_conf['solr_core_child'] = 'sios-l2';
$metsis_conf['solr_core_map_thumbnails'] = 'sios-thumbnail';
/**
 ...
 */
$metsis_conf['drupal_server'] = 'sios.metsis.met.no';
